...
- **Use the Poetry-managed virtual environment** (`poetry shell` or `poetry run`) whenever executing Python commands, including unit tests.
...
# ❗️Never edit pyproject.toml manually—always use the Poetry CLI
poetry add requests
